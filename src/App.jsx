...
function MainContent({ onLogout, setActiveView, activeView, isPlaying, setIsPlaying }) {
  ...
  return (
    <div className="min-h-screen text-romantic-900 font-sans selection:bg-romantic-200 selection:text-romantic-900 animate-fade-in-up bg-romantic-200">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/80 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-2xl font-script text-romantic-600 relative z-50 hover:scale-105 transition-transform">
            Bizim Hikayemiz
          </button>
          ...
          {/* Mobile Menu Button */}
          <button 
            className="md:hidden relative z-[110] p-2 text-romantic-900"
